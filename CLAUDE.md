...
- `config/SecurityConfig` — WebFlux security (`@EnableWebFluxSecurity`, `SecurityWebFilterChain`, `ReactiveJwtDecoder`) — permits `/auth/**` and `/actuator/**`, requires JWT for all else
